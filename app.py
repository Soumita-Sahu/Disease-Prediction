...
st.markdown("""
    <style>
        ...
        .sidebar-content h1, .sidebar-content h2, .sidebar-content h3 {
            color: #3b82f6 !important; /* Light sky blue */
        }

        /* Apply to specific markdown titles */
        section[data-testid="stSidebar"] h1 {
            color: #3b82f6;
        }
        section[data-testid="stSidebar"] h3 {
            color: #3498db;  /* Calm light blue */
            font-weight: 600;
        }
    </style>
""", unsafe_allow_html=True)

# --- Custom Sidebar Styling with Light Colors ---
st.markdown("""
    <style>
        /* Apply light elegant blue color to all sidebar headings */
        section[data-testid="stSidebar"] h1,
...
# --- HEADER with Elegant Glazed Blue Style ---
st.markdown(
    """
    <style>
        ...
        .header {
            ...
            font-size: 3rem;
            font-weight: 700;
            background: linear-gradient(90deg, #a0e9ff, #69b7ff);
